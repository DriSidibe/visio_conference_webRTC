...
class VideoConference(models.Model):
    teacher = models.ForeignKey(Teacher,related_name='teacher_conference',on_delete=models.CASCADE)
    link = models.CharField(max_length=250)
    time = models.IntegerField(max_length=250, blank=True, null=True)
