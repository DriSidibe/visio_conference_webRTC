...
urlpatterns =[
    ...
    path('get_teacher/<int:id>/',views.get_teacher_by_id,name="get_teacher"),
    path('video_conference/make/',views.make_video_conference,name="make_a_video_conference"),
    path('video_conference/join/',views.join_video_conference,name="join_a_video_conference"),
    path('video_conference_making_room/', views.conference_room,name="conference_room"),
    path('create_room/', views.create_conference),
    path('is_link_reachable/', views.is_link_reachable),
]
